...
#import "ActIf_2_PrefController.h"
...
@implementation ActIf_2_PrefController
...
{
	if (_specifiers == nil) {
		_specifiers = [self loadSpecifiersFromPlistName:@"ActIf_2_Pref" target:self];
		#if ! __has_feature(objc_arc)
		[_specifiers retain];
		#endif
	}
